...
//! and [Writing Tests](https://likewhatevs.github.io/scx-ktstr/guide/writing-tests.html)
...
/// for scx-ktstr's internal scenario catalog. External consumers define
...
///
/// ```
/// # use scx_ktstr::scenario::all_scenarios;
