...
//!
//! See the [Writing Tests](https://likewhatevs.github.io/scx-ktstr/guide/writing-tests.html)
//! and [`#[ktstr_test]` Macro](https://likewhatevs.github.io/scx-ktstr/guide/writing-tests/ktstr-test-macro.html)
...
///
/// Runs before `main()` in any binary that links against scx-ktstr.
///
