...
/// `stt_guest_init()` which handles the full init lifecycle and never
/// returns.
///
...
///   under nextest (`NEXTEST` env var set), delegates to [`stt_main`].
...
pub fn stt_test_early_dispatch() {
    ...
    // which runs the #[test] wrappers generated by #[stt_test].
...
/// [`SttTestEntry`] statics generated by the `#[stt_test]` macro.
...
///
/// Called automatically by [`stt_test_early_dispatch`] when running
