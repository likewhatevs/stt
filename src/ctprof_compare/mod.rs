...
mod pattern;
pub use pattern::pattern_display_label;
use pattern::{cgroup_normalize_skeleton, pattern_counts_union, pattern_key, tighten_group};
...
mod tests {
    use super::*;
    use super::pattern::{
        Segment, apply_systemd_template, cgroup_skeleton_tokens, classify_token,
        is_token_separator, split_into_segments,
    };
    use regex::Regex;
