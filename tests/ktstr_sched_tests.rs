...
use scx_ktstr::scenario::ops::{CgroupDef, CpusetSpec, HoldSpec, Step, execute_steps};
...
fn scenario_bpf_api(ctx: &scx_ktstr::scenario::Ctx) -> Result<scx_ktstr::assert::AssertResult> {
    let steps = vec![Step {
...
static __KTSTR_ENTRY_BPF_API: scx_ktstr::test_support::KtstrTestEntry =
    scx_ktstr::test_support::KtstrTestEntry {
        name: "sched_bpf_map_api_integration",
        func: scenario_bpf_api,
        scheduler: &KTSTR_SCHED,
        auto_repro: false,
        assert: scx_ktstr::assert::Assert::NONE.fail_on_stall(false),
        bpf_map_write: Some(&BPF_NOOP),
        duration: std::time::Duration::from_secs(10),
        ..scx_ktstr::test_support::KtstrTestEntry::DEFAULT
    };

/// Positive benchmarking test: scx-ktstr-sched under performance_mode passes
...
fn sched_perf_positive(ctx: &Ctx) -> Result<AssertResult> {
    use scx_ktstr::scenario::ops::execute_steps_with;
...
fn scenario_perf_negative(
    ctx: &scx_ktstr::scenario::Ctx,
) -> Result<scx_ktstr::assert::AssertResult> {
    use scx_ktstr::scenario::ops::execute_steps_with;
    let checks = scx_ktstr::assert::Assert::default_checks().max_gap_ms(50);
    let steps = vec![Step {
        setup: vec![CgroupDef::named("cg_0").workers(ctx.workers_per_cgroup)].into(),
        ops: vec![],
        hold: HoldSpec::FULL,
...
#[scx_ktstr::__linkme::distributed_slice(scx_ktstr::test_support::KTSTR_TESTS)]
#[linkme(crate = scx_ktstr::__linkme)]
static __KTSTR_ENTRY_PERF_NEG: scx_ktstr::test_support::KtstrTestEntry =
    scx_ktstr::test_support::KtstrTestEntry {
...
fn scenario_scattershot(ctx: &scx_ktstr::scenario::Ctx) -> Result<scx_ktstr::assert::AssertResult> {
    use scx_ktstr::scenario::ops::execute_steps_with;
    let checks = scx_ktstr::assert::Assert::default_checks()
        .max_gap_ms(10000)
        .max_spread_pct(80.0);
...
#[scx_ktstr::__linkme::distributed_slice(scx_ktstr::test_support::KTSTR_TESTS)]
#[linkme(crate = scx_ktstr::__linkme)]
static __KTSTR_ENTRY_SCATTER: scx_ktstr::test_support::KtstrTestEntry =
    scx_ktstr::test_support::KtstrTestEntry {
        name: "demo_scattershot_migration",
        func: scenario_scattershot,
        topology: scx_ktstr::test_support::Topology {
            sockets: 2,
            cores_per_socket: 2,
            threads_per_core: 1,
        },
...
#[scx_ktstr::__linkme::distributed_slice(scx_ktstr::test_support::KTSTR_TESTS)]
#[linkme(crate = scx_ktstr::__linkme)]
static __KTSTR_ENTRY_SLOW: scx_ktstr::test_support::KtstrTestEntry =
    scx_ktstr::test_support::KtstrTestEntry {
...
fn scenario_auto_repro(ctx: &scx_ktstr::scenario::Ctx) -> Result<scx_ktstr::assert::AssertResult> {
    let steps = vec![Step {
        setup: vec![CgroupDef::named("cg_0").workers(ctx.workers_per_cgroup)].into(),
        ops: vec![],
        hold: HoldSpec::FULL,
...
#[scx_ktstr::__linkme::distributed_slice(scx_ktstr::test_support::KTSTR_TESTS)]
#[linkme(crate = scx_ktstr::__linkme)]
static __KTSTR_ENTRY_AUTO_REPRO: scx_ktstr::test_support::KtstrTestEntry =
    scx_ktstr::test_support::KtstrTestEntry {
...
fn scenario_baseline(ctx: &scx_ktstr::scenario::Ctx) -> Result<scx_ktstr::assert::AssertResult> {
    let steps = vec![Step {
        setup: vec![CgroupDef::named("cg_0").workers(ctx.workers_per_cgroup)].into(),
        ops: vec![],
        hold: HoldSpec::FULL,
...
#[scx_ktstr::__linkme::distributed_slice(scx_ktstr::test_support::KTSTR_TESTS)]
#[linkme(crate = scx_ktstr::__linkme)]
static __KTSTR_ENTRY_EEVDF: scx_ktstr::test_support::KtstrTestEntry =
    scx_ktstr::test_support::KtstrTestEntry {
...
#[scx_ktstr::__linkme::distributed_slice(scx_ktstr::test_support::KTSTR_TESTS)]
#[linkme(crate = scx_ktstr::__linkme)]
static __KTSTR_ENTRY_SCX: scx_ktstr::test_support::KtstrTestEntry =
    scx_ktstr::test_support::KtstrTestEntry {
...
fn scenario_mid_degrade(ctx: &scx_ktstr::scenario::Ctx) -> Result<scx_ktstr::assert::AssertResult> {
    use scx_ktstr::scenario::ops::execute_steps_with;
    let checks = scx_ktstr::assert::Assert::default_checks().max_gap_ms(50);
    let steps = vec![
        Step {
...
#[scx_ktstr::__linkme::distributed_slice(scx_ktstr::test_support::KTSTR_TESTS)]
#[linkme(crate = scx_ktstr::__linkme)]
static __KTSTR_ENTRY_MID_DEGRADE: scx_ktstr::test_support::KtstrTestEntry =
    scx_ktstr::test_support::KtstrTestEntry {
